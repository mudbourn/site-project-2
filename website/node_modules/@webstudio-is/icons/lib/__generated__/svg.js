...
var ArrowDownNarrowWideIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width=".667" d="m2 10.667 2.667 2.666 2.666-2.666M4.667 13.333V2.667M7.333 2.667H10M7.333 5.333H12M7.333 8H14"/></svg>`;
var ArrowDownWideNarrowIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width=".667" d="m2 10.667 2.667 2.666 2.666-2.666M4.667 13.333V2.667M7.333 2.667H14M7.333 5.333H12M7.333 8H10"/></svg>`;
var ArrowDownZAIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width=".667" d="m2 10.667 2.667 2.666 2.666-2.666M4.667 2.667v10.666M10 2.667h3.333l-3.333 4h3.333M10 13.333V11a1.667 1.667 0 1 1 3.333 0v2.333M13.333 12H10"/></svg>`;
...
var ChevronFilledUpIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="currentColor" d="M13 11 8 5l-5 6"/></svg>`;
var ChevronLeftIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" width="100%" height="100%" style="display: block;"><g id="c1893fb9d__icon/chevron left"><path id="c1893fb9d__vector" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3" d="m9.256 4.499-3.512 3.5 3.512 3.502"/></g></svg>`;
...
var ChevronUpIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12 10 8 6l-4 4"/></svg>`;
...
var CircleIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="currentColor" fill-rule="evenodd" d="M8 3.65a4.35 4.35 0 1 0 0 8.7 4.35 4.35 0 0 0 0-8.7ZM2.35 8a5.65 5.65 0 1 1 11.3 0 5.65 5.65 0 0 1-11.3 0Z" clip-rule="evenodd"/></svg>`;
...
var EllipseIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="currentColor" fill-rule="evenodd" d="M3.373 5.736C2.203 6.405 1.65 7.229 1.65 8c0 .77.553 1.595 1.723 2.264C4.525 10.922 6.159 11.35 8 11.35c1.84 0 3.475-.428 4.627-1.086C13.797 9.595 14.35 8.771 14.35 8c0-.77-.553-1.595-1.723-2.264C11.475 5.078 9.841 4.65 8 4.65c-1.84 0-3.475.428-4.627 1.086Zm-.645-1.129C4.109 3.817 5.975 3.35 8 3.35c2.025 0 3.89.468 5.272 1.257 1.364.78 2.378 1.955 2.378 3.393 0 1.438-1.014 2.614-2.378 3.393-1.382.79-3.247 1.257-5.272 1.257-2.025 0-3.89-.468-5.272-1.257C1.364 10.613.35 9.438.35 8c0-1.438 1.014-2.614 2.378-3.393Z" clip-rule="evenodd"/></svg>`;
